 ...
 */
bool DictionaryManager::addDictionary(const QString &file, const QString &name, const QString &type)
{
...
QMap<QString, DictionaryPreferenceDialog *> DictionaryManager::generatePreferenceDialogs(KConfigSkeleton *config, QWidget *parent)
{
